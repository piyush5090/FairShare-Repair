const IndiMember = ({index,member,  fullname, totalSpend, username, email  }) =>{
        ...
        <div className="flex w-full h-[71px] px-2 mt-3 justify-between rounded-[15px] mb-[1px] bg-[rgba(242,236,236,0.17)]">
              <div className="px-1 justify-center items-center flex">
                ...
                <div className="w-auto flex flex-col justify-start"> 
                    ...
                    <p className="mx-2 text-[15px] font-[Montserrat] font-medium leading-[16px]  tracking-[0px] text-left text-gray-700">
                        {email}
                    </p>
                </div>
              </div>
